...
import { createGradeOwnMessagePrompt } from '../prompts/index.js';
...
router.post('/grade-own-message', async (req, res) => {
  const requestStartTime = Date.now();
  console.log('Starting /api/grade-own-message request at:', new Date().toISOString());
  ...
  try {
    ...
    console.log(`Grade own message completed: ${totalDuration}ms`);
    ...
    console.error('Failed to grade own message:', error);
